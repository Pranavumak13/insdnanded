          ...
          <div className="placementcell">
            <div className="para">
              ...
              <p>
                ...
                the placement fair we provide workshops on Resume building,
                cover letter writing, cracking aptitude test along with their
                regular curriculum of theory and practicals which give the
                students a hands-on experience in understanding the dynamics of
                the industry. Conducting mock interviews, encouraging students
                to build good connections in the industry, helping students to
                understand the job profile and the growth prospects of any job
                opportunity is a vital part of the placement cell. Not only
                in-house faculties but also live interaction with industry
                experts, professional trainers contribute to grooming and
                shaping the students in order to face the competitive industrial
                world.
              </p>
            </div>
          ...
          <div className="middlesection">
            ...
            <div className="middle3">
              ...
              <p>
                ...
                accounting and inculcate managerial and people skills required
                to run a successful business. The design industry is such that
                every individual has his/her own creative way of working, making
                it imperative to have their own business model that they can set
                up and run by themselves to achieve their goals and live their
                dreams.
              </p>{" "}
            </div>
          </div>
